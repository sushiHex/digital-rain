...
MODIFIED THIRD-PARTY SOURCE -- see route_b/NOTICE and route_b/LICENSE.nunchaku.

Derived from nunchaku/models/transformers/transformer_flux2.py in Nunchaku
1.2.1 (https://github.com/mit-han-lab/nunchaku), Copyright (c) MIT HAN Lab and
the Nunchaku contributors, licensed under the Apache License, Version 2.0. A
copy of that licence is at route_b/LICENSE.nunchaku.

This file HAS BEEN CHANGED relative to upstream: upstream PR #926 is applied to
add FLUX.2-klein support, attention is routed through an unfused QKV path so a
runtime hook can observe the projections, and the x_embedder is widened from
128 to 256 input channels for this project's glyph-latent conditioning. The
full statement of changes is in route_b/NOTICE.

You may not use this file except in compliance with the Apache License 2.0.
