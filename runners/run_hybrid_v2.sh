...
python eval_checkpoint.py --model black-forest-labs/FLUX.2-klein-base-9B --skip-generate --holdout eval_holdout --out eval_runs/hybrid_v2 >> run_hybrid_v2.log 2>&1
r2=$?
