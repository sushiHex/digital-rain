...
> **Records note, 2026-09-13.** That file was regenerated by round 2 (the
> union with the Z-Image labels,
> [`2026-09-13-the-gate-clears-its-bar-and-the-seed-clears-it-higher.md`](2026-09-13-the-gate-clears-its-bar-and-the-seed-clears-it-higher.md)).
> The round-1 record this note describes is preserved as
